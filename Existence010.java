...
public class Existence010 implements Existence {
	...
	public final String LABEL_E3 = "e3"; 
	public final String LABEL_E4 = "e4"; 
	public final String LABEL_R1 = "r1";
	public final String LABEL_R2 = "r2";
	public final String LABEL_R3 = "r3";
	public final String LABEL_R4 = "r4";
	...
	protected final int BOREDOME_LEVEL = 3;	
	...
	public Result returnResult010(Experiment experience){
		// Oops, this method was crude when I added more experiments.
		//boolean switcharoo = false;
		//if (Math.random()<.05)
		//	switcharoo = true;
